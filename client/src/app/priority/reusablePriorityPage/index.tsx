...
const columns: GridColDef[] = [
  {
    ...
    width: 100,
    renderCell: (params) => (
      <Link href={`/projects/${params.row.projectId}`}>{params.row.title}</Link>
    ),
  },
  {
    field: "description",
  ...
  },
  {
    ...
    width: 150,
    renderCell: (params) =>
      `${params.value.firstName} ${params.value.lastName}` || "Unknown",
  },
  {
    field: "assignee",
    headerName: "Assignee",
    width: 150,
    renderCell: (params) =>
      `${params.value.firstName} ${params.value.lastName}` || "Unassigned",
  },
];
